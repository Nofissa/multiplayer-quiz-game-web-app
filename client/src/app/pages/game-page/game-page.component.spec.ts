...
describe('gamePage', () => {
    ...
    describe('answerBoxes', () => {
        ...
        it('should contain three answer boxes if three choices during the game', () => {
            component.displayQuestion = true;
            component.questions[component.currentQuestionIndex].choices.push({ text: 'Choice 3', isCorrect: false });
            fixture.detectChanges();
        ...
        it('should contain four answer boxes if four choices during the game', () => {
            component.displayQuestion = true;
            component.questions[component.currentQuestionIndex].choices.push({ text: 'Choice 3', isCorrect: false });
            component.questions[component.currentQuestionIndex].choices.push({ text: 'Choice 4', isCorrect: true });
            fixture.detectChanges();
    ...
    describe('questioValue', () => {
        ...
        it('should display right question value during the game', () => {
            ...
            const expectedValue = component.questions[component.currentQuestionIndex].points;
    ...
    describe('timer', () => {
        ...
        it('should display correct amount of seconds left', () => {
            component.displayQuestion = true;
            component.secondsLeft = 36;
            fixture.detectChanges();

            const secondsLeft = fixture.debugElement.query(By.css('.timer-circle .centered-text'));
            expect(secondsLeft.nativeElement.textContent).toContain('Il reste 36 seconde(s)');
        });
    });
